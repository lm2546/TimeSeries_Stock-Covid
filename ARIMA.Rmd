...
fig1 <- fig1 +labs(title = "moderna&moderna Origin and Difference",
                   x='Date',y='Value')
fig1
```
...
fig1 <- fig1 +labs(title = "v1&v1 Origin and Difference",
                   x='Date',y='Value')
fig1
```
...
v1.ar <- arima(v1.train, order=c(1,1,4))
summary(v1.ar)
```
$$  X_{t} =  1.9944X_{t-1}-0.9944X_{t-2}+w_{t}-1.5327w_{t-1}+0.1243w_{t-2}+0.4017w_{t-3}+0.0115w_{t-4}$$
### 6
#### full model diagnostics
```{r}
sarima(v1.test,1,1,4)
```
...
fig1 <- fig1 +labs(title = "v2&v2 Origin and Difference",
                   x='Date',y='Value')
fig1
```
...
fig1 <- fig1 +labs(title = "v3&v3 Origin and Difference",
                   x='Date',y='Value')
fig1
```
